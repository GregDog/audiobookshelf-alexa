...
const en = {
  ...
  notMapped: 'This Echo is not mapped to an audiobookshelf user yet. Please ask the administrator to add this device to the user mapping.',
...
const de = {
  ...
  notMapped: 'Dieses Echo-Gerät ist noch keinem Audiobookshelf-Benutzer zugeordnet. Bitte ergänze die Geräte-Zuordnung in den Lambda-Variablen.',
